...
export const HomePage = () => {
  ...
  const { cryptos, loading, error, hasMore, page } = useSelector(state => state.crypto);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md border border-gray-100 dark:border-gray-700 text-center transition-colors duration-200">
            <p className="text-gray-500 dark:text-gray-400 text-sm font-medium">Total Cryptocurrencies</p>
            <p className="text-2xl font-bold text-gray-900 dark:text-white">{cryptos.length}</p>
          </div>
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md border border-gray-100 dark:border-gray-700 text-center transition-colors duration-200">
            <p className="text-gray-500 dark:text-gray-400 text-sm font-medium">Market Leaders</p>
            <p className="text-2xl font-bold text-blue-600 dark:text-blue-400">Top 50+</p>
          </div>
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md border border-gray-100 dark:border-gray-700 text-center transition-colors duration-200">
            <p className="text-gray-500 dark:text-gray-400 text-sm font-medium">Live Updates</p>
            <p className="text-2xl font-bold text-green-600 dark:text-green-400">Real-time</p>
          </div>
        </div>
