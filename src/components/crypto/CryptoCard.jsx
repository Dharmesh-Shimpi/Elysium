...
export const CryptoCard = React.memo(
				...
				<div className="flex items-center justify-between mb-4">
					<div className="flex items-center space-x-3">
						...
						<div>
							...
							<p className="text-gray-500 dark:text-gray-400 text-sm uppercase font-medium">
								{crypto.symbol}
							</p>
						</div>
					</div>
	...
	(prevProps, nextProps) => {
		...
		return (
			...
			prevCrypto.price_change_percentage_7d_in_currency ===
				nextCrypto.price_change_percentage_7d_in_currency &&
			prevCrypto.market_cap === nextCrypto.market_cap &&
			prevCrypto.total_volume === nextCrypto.total_volume &&
